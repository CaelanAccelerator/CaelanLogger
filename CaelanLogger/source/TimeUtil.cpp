...
namespace LogTime
{
    ...
    namespace
    {
        ...
        inline void NowSecMs(std::time_t &sec, int &ms)
        {
            timespec ts{};
        ...
        inline const char *CachedDateTimePrefix(std::time_t sec)
        {
        ...
        inline const char *CachedTimePrefix(std::time_t sec)
        {
            // "HH:MM:SS" => 8 chars + '\0'
            thread_local std::time_t cached_sec = 0;
    ...
    std::string nowTimeOnlyString()
    {
        ...
        const char *prefix = CachedTimePrefix(sec);
    ...
    std::string nowDateString()
    {
        ...
        const char *prefix = CachedDateTimePrefix(sec);
